...
class JadwalCard extends StatelessWidget {
  ...
  JadwalCard({required this.jadwal, required this.namaDaerah});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: shalatTimes.map((shalat) {
            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(fontSize: 12, color: isNext ? Colors.white : Colors.black54),
                    ),
                    SizedBox(height: 5),
                    Text(
                      shalat["nama"]!,
                      style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: isNext ? Colors.white : Colors.black),
                    ),
                  ],
                ),
              ),
              ...
              Expanded(
                ...
                child: Text(
                  ...
                  style: TextStyle(fontSize: isNext ? 22 : 18, fontWeight: FontWeight.bold, color: isNext ? Colors.white : Colors.black),
                ),
              ),
            ],
          ),
